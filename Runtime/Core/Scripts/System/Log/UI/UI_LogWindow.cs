...
namespace EmptyFrame.Core
{
    ...
    /// 日志系统窗口
    /// </summary>
    internal partial class UI_LogWindow : MonoBehaviour
    {
        ...
        [FoldoutGroup("视图"),SerializeField] private TextMeshProUGUI detailText;
        ...
        private bool isDirty = false;                                   //脏标记
    ...
    internal partial class UI_LogWindow
    {
        #region 菜单按钮
