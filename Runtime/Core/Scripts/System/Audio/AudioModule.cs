...
namespace EmptyFrame.Core
{
    ...
    internal partial class AudioModule
    {
        ...
        public void Init(AudioSystemSetting setting, Transform audioSourceRoot)
        {
    ...
    internal partial class AudioModule
    {
        ...
        private void CancelVolumeFade(AudioLocator locator)
        {
            ...
            MonoSystem.StopCoroutine(locator.FadeCoroutine);
            locator.FadeCoroutine = null;
        }
        #endregion
    ...
    internal partial class AudioModule
    {
        ...
        public void PlayOneShot(AudioClip audioClip, AudioPlayParams param)
        {
            ...
            MonoSystem.StartCoroutine(RecycleOneShot(locator, param.OnComplete));
        }
        ...
        public AudioPlayHandle PlayLoop(AudioClip audioClip, AudioPlayParams param)
        {
            ...
            if (param.FadeInDuration > 0f)
            {
                ...
                audioSource.Play();
                locator.FadeCoroutine = MonoSystem.StartCoroutine(DoVolumeFadeIn(locator, param.FadeInDuration));
            }
            else
            {
                locator.FadeMultiplier = 1f;
        ...
        public void StopLoop(AudioPlayHandle handle, float fadeDuration = 0f)
        {
            ...
            if (fadeDuration > 0f)
            {
                locator.FadeCoroutine = MonoSystem.StartCoroutine(DoVolumeFadeOut(locator, fadeDuration));
            }
            //常规回收
